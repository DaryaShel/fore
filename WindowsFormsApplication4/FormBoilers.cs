...
namespace WindowsFormsApplication4
{
    public partial class FormBoilers : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "sFUDataSet8.wvBoiler". При необходимости она может быть перемещена или удалена.
            this.wvBoilerTableAdapter.Fill(this.sFUDataSet8.wvBoiler);
        }
