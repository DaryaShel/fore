...
namespace WindowsFormsApplication4
{
    public partial class FormGas : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "sFUDataSet20.wvGas". При необходимости она может быть перемещена или удалена.
            this.wvGasTableAdapter.Fill(this.sFUDataSet20.wvGas);
